  ...
  return (
    <div className="pt-5 bg-white text-gray-800">
      ...
      >
        ...
        >
        <h2 className="text-5xl md:text-6xl Pretendard font-bold mb-8 text-gray-100 [text-shadow:0_2px_8px_rgba(0,0,0,0.8)] break-keep whitespace-normal">
          국제회의 · 포럼 · 전시/박람회 · 시상식
        </h2>

        <p className="text-lg md:text-xl font-normal tracking-wide max-w-2xl mx-auto text-gray-100 [text-shadow:0_2px_8px_rgba(0,0,0,0.8)] break-keep whitespace-normal">
