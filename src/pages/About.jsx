export default function About() {
  return (
    <div className="pt-32 max-w-6xl mx-auto px-6 text-gray-200 leading-relaxed">
      ...
      <section className="mb-20 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800 border border-gray-200 p-8 rounded-xl shadow-sm hover:shadow-md transition">
          ...
          {/* Team Members */}
          <svg className="w-8 h-8 mx-auto mb-4" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="7" r="3"/><circle cx="15" cy="7" r="3"/><path d="M4 21c0-3.5 2.5-6 5-6"/><path d="M20 21c0-3.5-2.5-6-5-6"/></svg>
          ...
          <div className="bg-gray border border-gray-200 p-8 rounded-xl shadow-sm hover:shadow-md transition">
            <h3 className="text-xl font-semibold mb-2 text-gray-200">이상현</h3>
            <p className="text-sm text-gray-300 leading-relaxed">IT지원</p>
          </div>
        </div>
      </section>
